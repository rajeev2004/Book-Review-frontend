...
function Register(){
    ...
    async function userRegister(e){
        e.preventDefault();
        try{
            const result=await axios.post(`${backend}/register`,{name,email,pass,code});
    ...
    return(
        <div className="container">
            <form className="form" onSubmit={userRegister}>
                ...
                <input type="text" placeholder="To login as Admin(optional)" value={code} onChange={(e)=>setCode(e.target.value)} />
